...
public class EnemyState : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning($"[EnemyController] {name}: No se asign� playerTransform en el Inspector.");
        }
    ...
    private void Update()
    {
        ...
        // Si el agente lleg� (o pr�cticamente lleg�) al waypoint actual, avanzamos al siguiente
    ...
    public void ChasePlayer()
    {
        ...
        Debug.Log($"[EnemyController] {name} entra en PERSECUCI�N hacia {playerTransform.name}");
    }
    ...
    private void StopChasing()
    {
        ...
        // Encontrar el waypoint m�s cercano para reanudar la patrulla:
        if (waypoints != null && waypoints.Length > 0)
        {
    ...
    private void GoNextWaypoint()  // Avanza al siguiente waypoint en orden c�clico.
    {
    ...
    {
        // Si ya est� investigando algo, ignoramos nuevos ruidos hasta terminar
        if (isInvestigating) return;
